...
Do not leave project task text in your documentation.  It muddles what your work was versus what the assignment tasking is, and will result in a point deduction.
...
6. Modify or create a **Network ACL**
   ...
   - Make sure screenshot includes content of the Inbound and Outbound rules
...
4. Prove with trial notes & screenshots that your Network ACL and Security Group are allowing or blocking traffic per your configurations.
5. Install `docker` per instructions for the AMI you chose. Provide a write up to confirm the docker container engine is working and docker allows the user to run containers (without `sudo`).
